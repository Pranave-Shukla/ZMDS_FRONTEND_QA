...
describe('nextId = incstr.idGenerator(opts)', () => {
  ...
  it('nextId() returns "baa" if opts={lastId:"cc",alphabet:"abc", numberlike: true}', () => {
    let nextId = incstr.idGenerator({lastId: 'cc', alphabet: 'abc', numberlike: true})
    expect(nextId()).to.equal('baa')
  })
  it('incstr.idGenerator({alphabet: "abcdb"}) throws', () => {
    expect(incstr.idGenerator.bind(incstr, {alphabet: 'abcdb'})).to.throw(TypeError)
  })
  it('incstr.idGenerator({alphabet: "abc", lastId: "d"})() throws', () => {
    let nextId = incstr.idGenerator({alphabet: 'abc', lastId: 'd'})
    expect(nextId.bind()).to.throw(RangeError)
  })
})
